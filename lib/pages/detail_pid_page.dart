...
class _DetailPidPageState extends State<DetailPidPage> {
  ...
  Future<void> _sendDataWedgeCommand(String command, String parameter) async {
    try {
      ...
      debugPrint("Error sending DataWedge command: $e");
    }
  }
  ...
  Future<void> _createProfile(String profileName) async {
    try {
      ...
      debugPrint("Error creating DataWedge profile: $e");
    }
  }

  void _onEvent(dynamic event) {
    setState(() {
      if (pidVM.tolistpid[widget.index].isApprove == "Counted" ||
          widget.flag == "history") {
        return;
      }

      final Map<String, dynamic> barcodeScan =
