...
class DetailPidPage extends StatefulWidget {
  final int index;
  final String flag;
  const DetailPidPage(this.index, this.flag);
  @override
  _DetailPidPage createState() => _DetailPidPage();
}

class _DetailPidPage extends State<DetailPidPage> {
  ...
  void initState() {
    ...
    clone = StockModel.clone(pidVM.tolistpid.value[widget.index]);
  ...
  void _onEvent(event) {
    setState(() {
      if (pidVM.tolistpid.value[widget.index].isapprove == "Counted" ||
          widget.flag == "history") {
      } else {
        ...
        if (_barcodeString != null && _barcodeString != "") {
          ...
          showMaterialModalBottomSheet(
            context: context,
            builder: (context) => modalBottomSheet(pidVM
  ...
  // void getData() async {
  //   pidVM.countedstring.value = await pidVM.counted();
                    ...
                    title: _isSearching
                        ...
                        : Container(
                            child: Align(
                                ...
                                child: TextWidget(
                                    text: "${pidVM.tolistpid.value[widget.index].location}" +
                                        " - " +
                  ...
                  child: Column(
                    ...
                    children: [
                                ...
                                child: ListView.builder(
                                    ...
                                    itemBuilder:
                                      ...
                                      return GestureDetector(
                                        child: headerCard2(pidVM.tolistpid
                      ...
                      widget.flag == "history"
                          ? Container()
                          : Visibility(
                              visible: pidVM.tolistpid.value[widget.index]
                                      .isapprove !=
                                  "Counted",
                              child: Container(
